...
const faqItems = [
  ...
  {
    question: "Where can I find documentation?",
    answer: "Our full documentation is available online at our knowledge base.",
  },
];

function FAQCard({ item, index, openIndex, toggleFAQ, delay }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="flex-shrink-0 text-indigo-600 text-2xl">
...
export default function FAQSection() {
  ...
  const rightFaqs = faqItems.filter((_, i) => i % 2 === 1);
